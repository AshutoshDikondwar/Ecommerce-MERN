...
const Shipping = () => {
  ...
  const [phoneNo, setPhoNo] = useState(shippingInfo.phoneNo)
      ...
      <div className="shippingContainer">
        <div className="shippingBox">
          ...
          <form className='shippingForm' encType='multipart/form-data' onSubmit={shippingSubmit}>
            ...
            <div>
              <PhoneIcon />
              <input type="number" placeholder='Phone Number' required value={phoneNo} onChange={(e) => setPhoNo(e.target.value)} />
            </div>
            <div>
              <PublicIcon />
