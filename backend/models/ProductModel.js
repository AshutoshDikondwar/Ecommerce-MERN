...
const productSchema = new mongoose.Schema({
    ...
    price: { type: Number, required: [true, "Please Enter Product Price"], maxLength: [8, "Price cannot exceed 8 figure"] },
    ...
    stock: { type: Number, required: [true, "Please Enter Product Stock"], maxLength: [4, "Stock cannot exceed 4 figure"], default: 1 },
